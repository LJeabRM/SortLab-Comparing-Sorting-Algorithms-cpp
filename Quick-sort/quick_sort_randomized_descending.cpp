...
int randomizedPartition(vector<int>& arr, int low, int high) {
    ...
    swap(arr[randomPivotIndex], arr[high]);  // Swap the chosen pivot with the last element
    return partition(arr, low, high);  // Call partition function
}
...
int main() {
    ...
    cout << "Sorted array (Descending) in: " << duration.count() << " microseconds" << endl;
